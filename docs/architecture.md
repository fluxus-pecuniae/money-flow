...
- `apps.dashboard.pt0_historical_replay`: PT0.0.2 adds the Historical Replay cockpit backed by `docs/pt0_0_2_historical_strategy_replay_summary.json`. It renders BTC/ETH/SOL x 15m/1h/4h historical candles, EMA overlays, historical entry/exit markers, trade inspector, dynamic 10,000 USDC equity panel, comparison table, and a separate sandbox execution ledger. Hyperliquid testnet market data is not used as strategy truth in this view.
