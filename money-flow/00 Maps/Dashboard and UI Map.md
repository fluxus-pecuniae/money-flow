...
- Dashboard cleanup: `DASH-PT1.1` removes the visible Audit tab and makes Paper Trading show configured Week 2 truth before runtime rows exist. `LOG-OBS1` adds read-only runtime log metadata and terminal log-watching helper support.
