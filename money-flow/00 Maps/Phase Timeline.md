...
| UAT | UAT0-UAT4 | UAT3.0.2 sandbox gate integration dry-run / policy hardening complete; UAT3.1 actual sandbox order submission remains blocked; sandbox review remains planned. |
