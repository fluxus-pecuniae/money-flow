...
| UAT | UAT0-UAT4 | UAT0.3 readiness preflight complete; UAT1 public read-only connectivity may proceed under constraints; later shadow run, approval-gated sandbox orders, and sandbox review remain planned. |
...
Current implemented milestone: `UAT0.3` top-20 universe, runtime drawdown, and UAT1 readiness preflight complete.
...
- UAT1: top-20 universe plus public read-only venue/market metadata may proceed under no-private/no-signed/no-order/no-API-key constraints.
