...
| UAT | UAT0-UAT4 | UAT1 public read-only connectivity and top-20 universe resolution complete; UAT2 shadow run is blocked pending shadow-readiness work; approval-gated sandbox orders and sandbox review remain planned. |
...
- UAT2: blocked shadow strategy run across top-20 supported assets with `next_candle_open` and `next_candle_close`, no orders.
