...
| UAT | UAT0-UAT4 | UAT1.1 shadow readiness complete; UAT2 shadow run may proceed as a no-order phase; approval-gated sandbox orders and sandbox review remain planned. |
...
- UAT2: no-order shadow strategy run across top-20 supported assets with `next_candle_open` and `next_candle_close`.
