...
flowchart TD
  ...
  Choice -->|explicit conversion| Intent[Child OrderIntent]
  Intent -->|explicit preview/readiness| Ready[Readiness]
  Ready -->|explicit gated submit| Submitted[SubmittedOrder]
