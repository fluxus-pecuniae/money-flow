...
| PT-RT1 | Real-time public-market paper observation substrate | Implements a forward-observation substrate rather than another evidence pack: Hyperliquid public mainnet market data is strategy truth, fully closed candle gating and indicators feed independent synthetic 10,000 USDC ledgers for the baseline and three review lanes, and a separate Hyperliquid testnet plumbing-probe lane is disabled/kill-switched/exact-approval gated by default. It does not regenerate canonical evidence packs, change rules, approve paper/live, or use testnet fills as strategy PnL. |
