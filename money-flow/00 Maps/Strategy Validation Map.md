...
| SV2.1 | Broad Hyperliquid 1D period evidence / Historical Replay | Public Hyperliquid mainnet `meta`/`candleSnapshot` evidence refresh targeted 183 active metadata symbols, generated 646 ignored baseline 1D period packs for 2024, 2025, YTD, and ALL, then generated 5116 selected Historical Replay chart/trade JSON files and 1912 evidence-only conservative candidate pack directories. This is broad 1D founder-review evidence only and does not supersede SV2.0.2 multi-timeframe canonical evidence. |
...
- SV2.1 proves the project can broaden public-mainnet 1D founder-review evidence across the active Hyperliquid metadata universe and visualize those period sets in Historical Replay, including the three conservative evidence-only candidates. It does not supersede SV2.0.2 canonical multi-timeframe evidence, approve candidates, or prove profitability.
