...
- Latest implemented scope: identity and canonical candle-file readiness after guarded import blocked on missing operator-verified identity and missing candle files.
