...
- Latest implemented scope: Hyperliquid-first public evidence review, dynamic-equity interpretation, trade-anatomy diagnostics, controlled research-only hypothesis experiments, SV1.15.1 methodology-truth hardening, SV1.16 per-candle true replay substrate, SV1.16.1 replay context/counter semantics, and SV1.17 full-suite lower-RSI plus market-structure replay experiments. BTC/ETH/SOL Hyperliquid research identity is operator-verified by `Tercirafael`, non-trading, and non-strategy-eligible; the intended migrated `money_flow` DB contains `25848` imported public campaign candles; evidence review generated component-scoped packs for `sleeve_15m`, `sleeve_1h`, and `sleeve_4h`; SV1.17 now covers BTC/ETH/SOL across 15m/1h/4h. Some variants improve losing baselines, ETH `sleeve_1h` baseline remains the strongest above-starting-equity pocket, and no production Money Flow rules changed. Aster/Binance remain later comparative candidates, OKX/Coinbase are blocked by missing public trade count, and Kraken is blocked by incomplete public REST coverage.
