...
`PT0.0.4 historical data backfill / replay regeneration may be scoped next; PT0.1 supervised top-20 paper/sandbox runtime remains future work and must use trusted market data for strategy truth`.
