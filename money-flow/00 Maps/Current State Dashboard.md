...
| UAT3.1 | blocked | Actual sandbox order submission requires explicit approval plus sandbox runtime enablement, sandbox account drawdown, risk, approval, submit-lease, lifecycle, and artifact-labeling verification. |
