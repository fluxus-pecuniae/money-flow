...
- Latest implemented scope: guarded canonical candle import attempt after readiness remained blocked on missing operator-verified identity and missing candle files.
