...
SV2.1 broad 1D period evidence is complete as a separate research refresh and now has Historical Replay artifacts. It used Hyperliquid public mainnet `meta` and `candleSnapshot` only, targeted 183 active public metadata symbols, imported available 1D candles back to 2024-01-01 where available, and generated 646 ignored baseline period packs for 2024, 2025, YTD, and ALL. The dashboard builder then generated 5116 ignored selected Historical Replay chart/trade JSON files and 1912 ignored evidence-only conservative candidate pack directories for `avoid_low_rolling_range_50`, `avoid_low_rolling_range_20`, and `mf_orig_1d_stage2_breakout_resistance_full_equity`. It broadens founder-review data for 1D only; it does not change Money Flow rules, supersede SV2.0.2 multi-timeframe evidence, approve a variant, approve paper/live, submit orders, or call private/signed/order endpoints.
