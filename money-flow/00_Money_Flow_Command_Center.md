...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `MF-ORIG-EV2` Original Money Flow multi-timeframe evidence packs + full-equity comparison replay complete; production Money Flow v1.2 unchanged |
