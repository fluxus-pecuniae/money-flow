...
- SV1.13.1 status: founder-readable interpretation pack added. Grouped aggregate totals are explicitly research-run sums rather than one account/scenario PnL; scenario-level fill/cost/drawdown evidence is visible; ETH `sleeve_1h` concentration is explicit; 15m and 4h remain negative in this public campaign; paper-trading design remains deferred.
