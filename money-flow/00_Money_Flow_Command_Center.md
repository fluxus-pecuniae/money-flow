...
- SV1.18 status: evidence credibility closeout and UAT candidate freeze. Current evidence does not prove edge; ETH `sleeve_1h` baseline is frozen only as a UAT observation candidate for plumbing/behavior validation, while 15m, 4h, BTC/SOL 1h, lower-RSI variants, market-structure variants, and cross-venue candidates are excluded from current UAT scope.
