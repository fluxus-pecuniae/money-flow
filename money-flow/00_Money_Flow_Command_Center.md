...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `PT-RT1.1B` Hyperliquid public mainnet data connection + expanded paper runtime readiness on top of completed `PT-RT1.1A`, `PT-RT1`, `OB2.0`, and `EV-AUDIT1`; 24-hour runtime collection is not started yet; no strategy candidate promoted |
| Current major track | Forward paper observation substrate after SV2.0.2 canonical baseline, SOR, MF-ORIG, EV-AUDIT1, and OB2.0 |
| Next recommended phase | Start `PT-RT1.1C` 24-hour public-mainnet probes-disabled runtime collection and retain ignored artifacts under `reports/paper_runtime/pt_rt1_1b_24h_dry_run/`; PT-RT1.2 is blocked until that passes |
...
| Paper trading | PT-RT1/PT-RT1.1A/PT-RT1.1B add synthetic paper-observation ledgers only. No strategy paper runtime is production-approved from EV-AUDIT1 or PT-RT1 evidence |
