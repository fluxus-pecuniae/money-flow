...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `SOR-EV2.2` Variant Chart Overlay complete; SOR-EV1/SOR-EV2 variants remain evidence-only |
| Current major track | Strategy Validation v2 evidence refresh |
| Next proposed phase | `SOR-EV3` narrower follow-up only if founder wants deeper filter/stop slices; `PT0.1` supervised top-20 paper/sandbox runtime week remains future work using trusted market data |
