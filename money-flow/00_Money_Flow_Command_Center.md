...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `PT-RT1.5.1` signed testnet transport + warm-start gate + open MTM hotfix on top of completed `PT-RT1.5`, `PT-RT1.4.1`, `PT-RT1.4`, `PT-RT1.3`, `PT-RT1.2`, `PT-RT1.1C`, `PT-RT1.1B`, `PT-RT1.1A`, `PT-RT1`, `OB2.0`, and `EV-AUDIT1`; no strategy candidate promoted |
