...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `SV2.0.2` Hardened Candle DB Import + Canonical SV2 Evidence Pack Generation complete; 2026-05-12 regenerated fully closed per-pair packs |
