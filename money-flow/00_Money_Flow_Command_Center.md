...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `SOR-EV2` true-forward stop/exit and rejected-signal replay complete; no variant promoted |
