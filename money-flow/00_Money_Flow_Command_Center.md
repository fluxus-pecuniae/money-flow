...
| UAT status | UAT1 public read-only connectivity may proceed under strict constraints |
...
- UAT1 public read-only connectivity may proceed under strict constraints.
