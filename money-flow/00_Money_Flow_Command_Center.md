...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `SOR-EV3` avoid_sideways_low_volatility drilldown complete; rolling-range variants are now available in Historical Replay; no SOR variant promoted |
