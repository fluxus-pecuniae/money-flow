...
- Research discovery: `STRAT-DISC1` is complete as research-only; it accepted 50 local public-mainnet selected replay datasets, ran 12 bounded candidate hypotheses, and promoted zero strategies.
...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `PT-RT1.5.3` Hyperliquid testnet size/precision hotfix on top of completed `PT-RT1.5.2`, `PT-RT1.5.1`, `PT-RT1.5`, `PT-RT1.4.1`, `PT-RT1.4`, `PT-RT1.3`, `PT-RT1.2`, `PT-RT1.1C`, `PT-RT1.1B`, `PT-RT1.1A`, `PT-RT1`, `OB2.0`, and `EV-AUDIT1`; no strategy candidate promoted |
...
| Next recommended phase | Continue or restart the active Week 1 session with PT-RT1.5.3 present; keep `1h`/`4h`/`1d` active, keep `15m` paused/legacy, confirm startup-valid signals are blocked until fresh post-start transitions, and review the next fresh baseline-triggered lifecycle row. For strategy discovery, do not promote STRAT-DISC1 near misses; add longer OOS/control-pocket data before any second pass. |
