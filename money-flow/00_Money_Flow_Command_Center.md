...
| Field | Current State |
| --- | --- |
| Current implemented milestone | `SOR-EV2.1` Evidence Lab / Variant Review dashboard complete; SOR-EV1/SOR-EV2 variants remain evidence-only |
