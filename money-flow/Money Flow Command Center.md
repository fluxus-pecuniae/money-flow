...
Current focus: Strategy Validation guarded canonical candle import readiness. The intended local `money_flow` DB is migrated/current but still has zero candles, BTC/ETH/SOL research identity was not seeded because operator verification was not supplied, all 18 timezone-explicit candle files remain missing, no candles or evidence packs are generated in SV1.12.3, and paper trading is not approved.
