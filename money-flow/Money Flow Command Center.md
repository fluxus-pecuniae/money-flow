...
Current focus: Strategy Validation market-identity and candle-data readiness. The intended local `money_flow` DB is migrated/current, SV1.11.1 hardens operator-verified identity writes and requirement-aware candle preflight, no first real canonical evidence packs have been generated yet, and paper trading is not approved.
