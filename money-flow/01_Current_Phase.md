...
- Current runtime config: `PT-RT1.6` founder-selected Week 2 slate is prepared; no active paper run is assumed unless verified by the local control server.
...
- Next recommended action: after founder review, start the `pt_rt1_6_week2_active` paper run from the dashboard control server or documented command.
