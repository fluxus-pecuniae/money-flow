...
Run the PT-RT1 24-hour probes-disabled dry run first. If public-mainnet data health, fully closed candle gating, duplicate prevention, indicator availability, and synthetic ledgers remain stable, start the 60-day public-mainnet forward-observation window. Testnet plumbing probes require separate exact approval text and must remain isolated from strategy PnL.
