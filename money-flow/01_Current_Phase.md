...
`PT0.0.2` Historical Strategy Replay Cockpit is complete, including a research-only MACD-removed replay selector beside the OG replay/strategy. The follow-up PT0 dashboard chart correctness Playwright hotfix is also complete. PAPER TRADING IS APPROVED. BROADER TOP-20 HYPERLIQUID-SUPPORTED PAPER/SANDBOX TRADING IS APPROVED.
