...
- UAT3.3: additional sandbox lifecycle testing is blocked; it requires separate founder/operator approval, recognized/authorized testnet user/API wallet, and sufficient sandbox equity before attempting accepted/open -> cancel coverage.
