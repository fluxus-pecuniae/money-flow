...
- PT0.0.4: historical data backfill / replay regeneration may be scoped later.
- PT0.1: supervised top-20 paper/sandbox runtime week may be scoped later using trusted market data.
