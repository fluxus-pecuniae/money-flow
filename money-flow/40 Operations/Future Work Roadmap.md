...
- UAT3.1: first approval-gated sandbox order blocked pending explicit approval, live-fed sandbox drawdown, real sandbox submit path wiring, executable approval-scope gate wiring to persistence, risk gate wiring to the submit path, and submit-lease integration verification.
