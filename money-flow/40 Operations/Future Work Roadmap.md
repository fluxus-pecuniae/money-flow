...
Paper trading runtime is not implemented. Paper trading is not approved as an automated order path. Live trading is not approved. Additional exchange order submission is not approved.
...
- PT0: approval-gated paper/sandbox trading runtime may be scoped later; not implemented by UAT4.2.
