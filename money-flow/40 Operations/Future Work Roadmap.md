...
- UAT3.2: additional sandbox lifecycle testing is not approved; it requires separate founder/operator approval and sandbox account/API-wallet configuration review before attempting accepted/open -> cancel coverage.
