...
Last reviewed: `2026-06-11T15:00:00Z`
...
- TSMOM-EV1 tested vol-targeted trend on the liquid majors: relative risk-adjusted pass vs buy-and-hold OOS (with absolute-performance qualifiers - the strategy still lost 12.2% OOS in a bear; defensive value only; authored mixed). Queued next: the FUNDING phase - model perp funding costs (the long/short rows with positive OOS Sharpe (+0.22) are upper bounds until funding is priced in; any defensive-overlay follow-up also needs it).
