...
Last reviewed: `2026-06-12T09:00:00Z`
...
- **MONEYFLOW-SIGNAL1 is the next research phase** — REGIME2 produced the gate it will import (`strategy_types.resolve_regime_filter()`, default pinned to the REGIME2 selection): endpoint-strong but process-unstable, verdict embedded — treat as informational risk context, not validated control.
- (MONEYFLOW-SIGNAL1 unparked above — REGIME1 resolved.)
