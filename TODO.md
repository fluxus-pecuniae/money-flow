...
Last reviewed: `2026-06-12T07:30:00Z`
...
- **MONEYFLOW-SIGNAL1 is the next research phase** — unparked now that REGIME1 produced the risk-off gate it will use (`strategy_types.resolve_regime_filter()`), with the caveat that the gate carries a failed value verdict and is informational risk context only.
