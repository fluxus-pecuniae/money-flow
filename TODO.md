...
Last reviewed: `2026-06-12T02:30:00Z`
...
- **FUND-VENUES1 (queued — now unblocked by DATA1)**: the funding-carry family is closed at retail and at scale on Hyperliquid+Kraken citations (FUND-EV2/FUND-SCALE1); FUND-VENUES1 would be the structural re-open ONLY if a venue with a materially different cited fee/rebate regime (e.g., maker rebates) is documented — new citations, new phase, never a re-tune of the closed grids. DATA1 gives it the venue-fair funding base (five venues' funding aligned daily with honest depth limits); any test design must respect the recorded coverage gaps (OKX ~3 months of funding history; Kraken Futures ~1y).
