...
- SV1.6 through SV1.9.1 add no migration; canonical evidence-review summaries, DB target / reachability / schema / migration / candle-table gap truth, required strategy-validation table checks, canonical candle import requirements, partial-evidence status, first-real-run historical-data bootstrap reporting, schema-gated evidence-pack generation, DB-target evidence-generation blocking, and candle-import timestamp/provenance summary hardening use existing campaign configs, existing candle tables when present, and saved research outputs only.
...
- SV1.0 / SV1.0.1 / SV1.1 / SV1.2 / SV1.2.1 / SV1.3 / SV1.4 / SV1.4.1 / SV1.5 / SV1.5.1 / SV1.6 / SV1.7 / SV1.8 / SV1.8.1 / SV1.9 / SV1.9.1 Money Flow validation/backtesting, research-campaign, evidence-readiness, evidence-integrity, historical-data readiness, evidence-review, DB/schema bootstrap, schema-gated first-real-run data-gap, evidence-target truth, and candle-import timestamp/provenance service boundary.
