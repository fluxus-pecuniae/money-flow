...
- Phase 7.1 adds durable operator approval records for explicit same-target automation action gates; approvals can be active, revoked, consumed, or expired and never execute the approved action by themselves.
