...
- SV1.16 replay results are wired into the dashboard under the `Experiments` tab replay filter, separate from Evidence-tab evidence-pack/review data. The static dashboard remains visualization-only for local evidence and experiment/replay artifacts.
