...
- Includes exchange, market data, indicators, portfolio, planning, risk, routing assessment / readiness-audit / recommendation / target-choice, execution, and SV1.0-SV1.2 strategy-validation contracts.
...
- SV1.0 / SV1.0.1 / SV1.1 / SV1.2 Money Flow validation/backtesting service boundary.
...
- Includes `scripts/run_money_flow_validation_batch.py` for SV1.1/SV1.2 read-only comparative Money Flow validation across explicit matrices of components, fill timings, symbols, date windows, and cost assumptions, including repeated `--window start,end` support.
...
- SV1.2 data-coverage and market-regime validation: verifies complete/thin coverage diagnostics, deterministic uptrend/downtrend/sideways/unknown labels, regime-grouped trade metrics, Markdown regime/data sections, repeated CLI windows, no optimization/recommendation language, and no live artifacts.
