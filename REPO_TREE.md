...
- SV2.1 adds `scripts/run_sv21_broad_1d_period_evidence.py`, `docs/sv2_1_broad_hyperliquid_1d_period_evidence.md`, and `docs/sv2_1_broad_hyperliquid_1d_period_evidence_summary.json` for broad active-Hyperliquid-public-metadata 1D period evidence. Generated raw candles and generated period campaign configs remain local under `/tmp/money-flow-sv21-broad-1d/`; generated evidence packs remain ignored under `reports/strategy_validation/`. The first SV2.1 run targeted 183 active public metadata symbols, imported public 1D candles back to 2024-01-01 where available, and generated 646 period packs across 2024, 2025, YTD, and ALL without changing Money Flow rules or approving paper/live.
