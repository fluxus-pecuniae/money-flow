...
- SV1.6 through SV1.8 add no migration; canonical evidence-review summaries, DB reachability / schema / migration / candle-table gap truth, partial-evidence status, and first-real-run historical-data bootstrap reporting use existing campaign configs, existing candle tables when present, and saved research outputs only.
...
- SV1.0 / SV1.0.1 / SV1.1 / SV1.2 / SV1.2.1 / SV1.3 / SV1.4 / SV1.4.1 / SV1.5 / SV1.6 / SV1.7 Money Flow validation/backtesting, research-campaign, evidence-readiness, evidence-integrity, historical-data readiness, evidence-review, and first-real-run data-gap service boundary.
