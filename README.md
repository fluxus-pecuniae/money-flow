...
- Current runtime: `PT-RT1.5.3` size/precision hotfix verified; the fixed 25 USDC Hyperliquid testnet smoke was accepted/open, canceled, and reconciled.
...
- Current phase truth: `PT-RT1.5.3` fixes Hyperliquid testnet size/precision formatting for fixed 25 USDC baseline-only plumbing orders; DOCS-OB2.1 is documentation/governance only when active.
