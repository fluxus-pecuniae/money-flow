...
- live routing execution, best-binding selection, and CBBO aggregation
...
- future Phase 6.x work may add a recommendation-backed submitted-order handoff, route-executor/automation hardening, DB-level concurrency/serialization hardening before automation, slippage/price guard policy, and richer market-data quality before any ranking/scoring work; Phase 6.3 already added explicit accepted recommendation-backed target-choice conversion to one child intent, and Phase 6.4/6.4.1 only harden preview/readiness inspection without auto-submit, fanout, CBBO, venue scoring, route executor behavior, target reselection, automatic target-choice creation, child-intent auto-creation, or submitted-order creation from recommendation
