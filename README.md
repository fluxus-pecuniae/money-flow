...
- future Phase 6.x work may add recommendation-to-child-intent conversion or richer policy design, but Phase 6.2.2 still has no auto-submit, fanout, CBBO, venue scoring, route executor behavior, target reselection, automatic target-choice creation, child-intent auto-creation, or submitted-order creation from recommendation
